...
import 'package:task_app/src/features/auth/application/reset_password_controller.dart';
import 'package:task_app/src/features/auth/application/settings_controller.dart';
...
import 'package:task_app/src/features/auth/domain/repositories/email_code_repository_interface.dart';
...
import 'package:task_app/src/features/auth/infrastructure/datasources/local/jwt_local_data_source.dart';
import 'package:task_app/src/features/auth/infrastructure/datasources/local/theme_local_data_source.dart';
import 'package:task_app/src/features/auth/infrastructure/datasources/local/user_local_data_source.dart';
import 'package:task_app/src/features/auth/infrastructure/datasources/remote/email_code_remote_data_source.dart';
import 'package:task_app/src/features/auth/infrastructure/datasources/remote/jwt_remote_data_source.dart';
import 'package:task_app/src/features/auth/infrastructure/datasources/remote/reset_password_remote_data_source.dart';
import 'package:task_app/src/features/auth/infrastructure/datasources/remote/user_remote_datasource.dart';
import 'package:task_app/src/features/auth/infrastructure/repositories/auth_repository.dart';
import 'package:task_app/src/features/auth/infrastructure/repositories/email_code_repository.dart';
import 'package:task_app/src/features/auth/infrastructure/repositories/reset_password_repository.dart';
import 'package:task_app/src/features/auth/infrastructure/repositories/settings_repository.dart';

import 'application/auth_controller.dart';
import 'application/email_code_controller.dart';
...
final resetPasswordControllerProvider = StateNotifierProvider<
  ...
  return ResetPasswordController(repository: repo);
});
...
final emailCodeControllerProvider =
  ...
  return EmailCodeController(repository: repo);
});
