...
class TaskEditController extends StateNotifier<AsyncValue<void>> {
  final TaskRepositoryInterface repository;

  TaskEditController({required this.repository})
  ...
  Future<Either<Failure, TaskEntity>> handle(
    ...
    return await title.value.fold((failure) {
      ...
      return await description.value.fold((failure) {
        ...
        final res = await repository.updateTask(TaskEntity(
            id: id,
            title: title,
