...
from authentication.tasks import send_account_verification_code, send_password_reset_code
...
class ChangePasswordView(generics.CreateAPIView): 
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            if not self.user.check_password(serializer.data["old_password"]):
                return Response(
                    {
                        "old_password": _("Password not valid")
                    }
